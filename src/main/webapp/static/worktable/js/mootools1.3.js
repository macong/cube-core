...
//这个应该在调试后删除！！！！			
console.log('mootools.js line:3881 error:p['+property+'],v['+value+']');
		}
		return this;
	},
...
//MooTools: the javascript framework.
//Load this file's selection again by visiting: http://mootools.net/more/42033c611b78e978189af584bb43941d 
//Or build this file again with packager using: packager build More/More More/Events.Pseudos More/Class.Refactor More/Class.Binds More/Class.Occlude More/Array.Extras More/Date More/Date.Extras More/Number.Format More/Object.Extras More/String.Extras More/String.QueryString More/URI More/URI.Relative More/Hash More/Hash.Extras More/Element.Forms More/Element.Event.Pseudos More/Element.Event.Pseudos.Keys More/Element.Measure More/Element.Position More/Element.Shortcuts More/Fx.Scroll More/Drag More/Drag.Move More/Slider More/Sortables More/Request.JSONP More/Request.Queue More/Request.Periodical More/Assets More/Hash.Cookie More/IframeShim More/Keyboard More/Keyboard.Extras More/Mask More/Scroller More/Tips More/Spinner More/Locale More/Locale.en-US.Date More/Locale.en-US.Number
/*
---
...
Locale.define('en-US', 'Date', {
	...
	lessThanMinuteAgo: '不到1分钟前',//'less than a minute ago'
	minuteAgo: '1 分钟前',//about a minute ago
	minutesAgo: '{delta}分钟前',//'{delta} minutes ago'
	hourAgo: '1小时前',//'about an hour ago'
	hoursAgo: '{delta}小时前',//'about {delta} hours ago'
	dayAgo: '1 day ago',//'1 day ago'
	daysAgo: '{delta} days ago',//'{delta} days ago'
	weekAgo: '1 week ago',//'1 week ago'
	weeksAgo: '{delta} weeks ago',//'{delta} weeks ago'
	monthAgo: '1 month ago',//'1 month ago'
	monthsAgo: '{delta} months ago',//'{delta} months ago'
	yearAgo: '1 year ago',//'1 year ago'
	yearsAgo: '{delta} years ago',//'{delta} years ago'

	lessThanMinuteUntil: 'less than a minute from now',//'less than a minute from now'
	minuteUntil: 'about a minute from now',//'about a minute from now'
	minutesUntil: '{delta} minutes from now',//'{delta} minutes from now'
	hourUntil: 'about an hour from now',//'about an hour from now'
	hoursUntil: 'about {delta} hours from now',//'about {delta} hours from now'
	dayUntil: '1 day from now',//'1 day from now'
	daysUntil: '{delta} days from now',//'{delta} days from now'
	weekUntil: '1 week from now',//'1 week from now'
	weeksUntil: '{delta} weeks from now',//'{delta} weeks from now'
	monthUntil: '1 month from now',//'1 month from now'
	monthsUntil: '{delta} months from now',//'{delta} months from now'
	yearUntil: '1 year from now',//'1 year from now'
	yearsUntil: '{delta} years from now'//'{delta} years from now'
...
//日期定义参数
Date.defineFormat("times","%Y-%m-%d %H:%M:%S");
Date.defineFormat("time","%Y-%m-%d %H:%M");
Date.defineFormat("date","%Y-%m-%d");
...
Drag.Move = new Class({
	...
	stop: function(event){
		...
		this.fireEvent('drop', [this.element, this.overed, event,this.mouse.now]);
		this.overed = null;
...
//		if(this.options.activeProp && targetEl.get(this.options.activeProp)=='false'){
		if(this.options.activeProp && (targetEl.get(this.options.activeProp)=='false')||targetEl.getParent("["+this.options.activeProp+"=false]")){
			return event;
		}
		if (
			!this.idle ||
			event.rightClick ||
			['button', 'input', 'a'].contains(targetEl.get('tag'))
		) return;
